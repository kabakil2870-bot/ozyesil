              ...
              {cart.length === 0 ? (
                <div className="my-auto py-16 text-center space-y-4">
                  ...
                  <p className="text-xs text-neutral-500 max-w-xs mx-auto">
                    Mağazamızdaki binlerce orijinal kozmetik ürünü arasından beğendiklerinizi hemen sepetinize ekleyin!
                  </p>
                  <button
                    onClick={() => setIsCartOpen(false)}
            ...
            {cart.length > 0 && (
              <div className="p-6 bg-neutral-50 border-t border-neutral-200 space-y-3">
                <div className="flex items-center justify-between text-sm">
                  <span className="text-neutral-600 font-medium">Toplam Tutar</span>
                ...
                <a
                  ...
                  className="w-full py-3.5 bg-emerald-600 hover:bg-emerald-700 text-white font-bold text-sm rounded-2xl shadow-md hover:shadow-lg transition-all flex items-center justify-center gap-2 group"
                >
